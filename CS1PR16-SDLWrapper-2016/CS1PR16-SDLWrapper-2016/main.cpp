...
int main(int argc, char * argv[])
{
	...
	window = SDL_CreateWindow("Maze Game", 100, 100, 1200, 600, SDL_WINDOW_SHOWN);
	...
	SDL_Texture* ImageSurface = IMG_LoadTexture(renderer, "GameBackground01.bmp");
	...
	while (mainEvent->type != SDL_QUIT) {
		...
		SDL_RenderCopy(renderer, ImageSurface, NULL, NULL);

		SDL_RenderPresent(renderer);

	}

	//when ending the program, SDL window, renderer and event closed
