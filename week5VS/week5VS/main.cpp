    ...
    while(1){
        ...
        if(choice=='1'){
            ...
            while(1){
				...
				if (choice == '1' && firstBookBot.PickUpBook(bookDrop))
					break;
                else if (choice =='2' && firstBookBot.PickUpBook(firstBookPile))
					break;
				else if (choice =='3' && firstBookBot.PickUpBook(secondBookPile))
                    break;
                else if (choice =='4' && firstBookBot.PickUpBook(pileHistory))
                    break;
                else if (choice =='5' && firstBookBot.PickUpBook(pileReference))
                    break;
                else if (choice =='6' && firstBookBot.PickUpBook(pileBiography))
                    break;
                else if (choice =='7' && firstBookBot.PickUpBook(pileFiction))
                    break;
                else if (choice =='8')
                    break;
            ...
            while(choice !='8'){
                ...
                cin>>choice2;
                //all valid choices
                if (choice2=='1' && firstBookBot.PlaceDownBook(bookDrop))
					break;
                else if (choice2=='2' && firstBookBot.PlaceDownBook(firstBookPile))
                    break;
                else if (choice2=='3' && firstBookBot.PlaceDownBook(secondBookPile))
                    break;
                else if (choice2=='4' && firstBookBot.PlaceDownBook(pileHistory))
                    break;
                else if (choice2=='5' && firstBookBot.PlaceDownBook(pileReference))
                    break;
                else if (choice2=='6' && firstBookBot.PlaceDownBook(pileBiography))
					break;
                else if (choice2=='7' && firstBookBot.PlaceDownBook(pileFiction))
                    break;
